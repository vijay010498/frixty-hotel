...
const Admin = (props) => {
  ...
  //User Authentication verification run only at initial render
  React.useEffect(() => {
    async function verifyAuth() {
      return await axios.get("/api/secure/sAdmin/verifyAuth");
    }
    verifyAuth()
      .then((response) => {
  ...
  return (
    <div className="wrapper">
      {checkForSpinner()}
      {verified ? console.log("Login verified") : <Redirect to="/auth" />}
